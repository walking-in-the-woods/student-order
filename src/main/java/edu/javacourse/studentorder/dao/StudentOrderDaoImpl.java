...
public class StudentOrderDaoImpl implements StudentOrderDao {
    ...
    private static final String INSERT_ORDER =
            "INSERT INTO jc_student_order(" +
                    ...
                    "h_passport_series, h_passport_number, h_passport_date," +
                    "h_passport_office_id, h_post_index, h_street_code, h_building, " +
                    "h_extension, h_apartment, h_university_id, h_student_number, " +
                    "w_sur_name, w_given_name, w_patronymic," +
                    "w_date_of_birth, w_passport_series, w_passport_number, " +
                    "w_passport_date, w_passport_office_id, w_post_index, " +
    ...
    private static final String SELECT_ORDERS =
            "SELECT so.*, ro.r_office_area_id, ro.r_office_name, " +
                    ...
                    "INNER JOIN jc_passport_office po_h " +
                    "ON po_h.p_office_id = so.h_passport_office_id " +
                    "INNER JOIN jc_passport_office po_w " +
                    "ON po_w.p_office_id = so.w_passport_office_id " +
    ...
    private static final String SELECT_ORDERS_FULL =
            "SELECT so.*, ro.r_office_area_id, ro.r_office_name, " +
                    ...
                    "INNER JOIN jc_passport_office po_w " +
                    "ON po_w.p_office_id = so.w_passport_office_id " +
                    "INNER JOIN jc_student_child soc " +
                    "ON soc.student_order_id = so.student_order_id " +
                    "INNER JOIN jc_register_office ro_c " +
                    "ON ro_c.r_office_id = soc.c_register_office_id " +
                    "WHERE student_order_status = ? " +
    ...
    public Long saveStudentOrder(StudentOrder so) throws DaoException {
        ...
        try (Connection con = getConnection();
            ...
            // Disable automatic transaction management mode
...
//            int counter = 0; // For highload solutions only
...
//            }
    ...
    private void setParamsForChild(PreparedStatement stmt, Child child) throws SQLException {
        ...
        stmt.setString(6, child.getBirthCertificateNumber());
...
//        return getStudentOrdersTwoSelect();
    ...
    private Child fillChild(ResultSet rs) throws SQLException {
        ...
        child.setBirthCertificateNumber(rs.getString("c_certificate_number"));
